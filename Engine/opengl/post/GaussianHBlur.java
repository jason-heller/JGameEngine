...
public class GaussianHBlur extends PostShader {
	private static final String VERTEX_SHADER = "opengl/post/glsl/hblur_vertex.glsl";
	private static final String FRAGMENT_SHADER = "opengl/post/glsl/gaussian.glsl";
