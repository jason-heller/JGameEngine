...
public class LineShader extends ShaderProgram {
	private static final String VERTEX_SHADER = "debug/tracers/tracerVertex.glsl";
	// private static final InnerFile GEOMETRY_SHADER = new
	// InnerFile("utils/tracers", "tracerGeometry.glsl");
	private static final String FRAGMENT_SHADER = "debug/tracers/tracerFragment.glsl";
