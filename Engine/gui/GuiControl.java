...
import gui.renderer.GuiImageShader;
...
public class GuiControl {
	...
	public static Text drawText(Font font, String text, int x, int y, float fontSize, int lineWidth, boolean centered, int... offsets) {
		Text txt = new Text(font, text, x, y, fontSize, lineWidth, centered, offsets);
		txt.setOpacity(opacity);
		txt.markAsTemporary();
		addComponent(txt);
		return txt;
