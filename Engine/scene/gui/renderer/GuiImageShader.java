...
public class GuiImageShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "scene/gui/renderer/guiVertex.glsl";
	private static final String FRAGMENT_FILE = "scene/gui/renderer/guiFragment.glsl";
